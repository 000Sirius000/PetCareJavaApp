...
public class ActivityDistanceBarChartView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("km", 12f, top + 18f, textPaint);
        ...
        for (int i = 0; i < bars.size(); i++) {
            ...
            if (bar.distanceKm > 0d) canvas.drawText(FormatUtils.number(bar.distanceKm), x + 2f, y - 8f, textPaint);
            if (shouldShowXAxisLabel(i, bar.label)) canvas.drawText(bar.label, x - 6f, bottom + 28f, textPaint);
        }
    }
